 ...
 * uses Euler angles in radians for consistency with GLM, though this can lead to gimbal
 * lock in extreme cases. The component provides helper methods to generate
 * the final transformation matrix and perform common transform operations.
 * 
...
struct Transform {
  ...
  [[nodiscard]] glm::vec3 getForward() const {
    glm::mat4 rotMatrix = glm::rotate(glm::mat4(1.0f), rotation.x, glm::vec3(1, 0, 0));
