...
void Shader::use() const {
    glUseProgram(this->mRendererId);
}

void Shader::setBool(const std::string& name, const bool value) const {
    glUniform1i(glGetUniformLocation(this->mRendererId, name.c_str()), static_cast<int>(value));
}
...
void Shader::setMat4(const std::string& name, const glm::mat4& value) const {
  glUniformMatrix4fv(glGetUniformLocation(this->mRendererId, name.c_str()), 1, GL_FALSE, glm::value_ptr(value));
}